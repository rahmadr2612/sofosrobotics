        ...
        <div class="d-flex">
         ...
         <div class="navbar-brand-box">
            {{-- <a href="index.html" class="logo logo-dark">
                ...
                <span class="logo-lg">
                    <img src="{{ url('') }}/assets/admin/images/logo-dark.png" alt="" height="20">
                </span>
            </a>
            ...
            <a href="index.html" class="logo logo-light">
                ...
                <span class="logo-lg">
                    <img src="{{ url('') }}/assets/admin/images/logo-light.png" alt="" height="20">
                </span>
            </a> --}}
                <span class="logo">Sofosrobotics</span>
        </div>
        ...
        <div class="d-flex">
            ...
            <div class="dropdown d-inline-block">
                <button type="button" class="btn header-item waves-effect" id="page-header-user-dropdown"
                    data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                    <img class="rounded-circle header-profile-user" src="{{ url('') }}/assets/admin/images/users/avatar-7.jpg"
                        alt="Header Avatar">
                    <span class="d-none d-xl-inline-block ms-1">{{ session('nama') }}</span>
