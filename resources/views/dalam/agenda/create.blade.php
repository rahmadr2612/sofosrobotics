...
<div class="row">
    ...
    <div class="card">
        <div class="card-header">
            <h5>Input Master Event</h5>
        </div>
        <form class="form theme-form" action="{{ url('') }}\admin\agenda" method="post" enctype="multipart/form-data">
            @csrf
            <div class="card-body">
                <div class="row">
                    <div class="col">
                        ...
                        <div class="mb-3 row">
                            <label class="col-sm-3 col-form-label">Foto Event</label>
                            <div class="col-sm-9">
