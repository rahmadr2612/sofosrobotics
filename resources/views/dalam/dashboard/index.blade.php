                ...
                <ul class="list-unstyled activity-wid mb-0">
                    ...
                    <li class="activity-list activity-border">
                        <div class="activity-icon avatar-sm">
                          ...
                          <img src="/dalam/images/users/avatar-7.jpg" class="avatar-sm rounded-circle" alt="">
                    ...
                    <div class="carousel-inner">
                        ...
                        <div class="carousel-item active">
                            <div class="row align-items-center mb-5">
                                <div class="col-md-4">
                                    <img src="/dalam/images/product/img-3.png"
                        ...
                        <div class="carousel-item">
                            <div class="row align-items-center mb-5">
                                <div class="col-md-4">
                                    <img src="/dalam/images/product/img-5.png"
                                        class="img-fluid me-3" alt="">
                                </div>
                                <div class="col-md-7 offset-md-1">
                        ...
                        <div class="carousel-item">
                            <div class="row align-items-center mb-5">
                                <div class="col-md-4">
                                    <img src="/dalam/images/product/img-1.png"
                                        class="img-fluid me-3" alt="">
                                </div>
                                <div class="col-md-7 offset-md-1">
                ...
                <div class="table-responsive">
                    <table class="table table-centered table-nowrap mb-0">
                        ...
                        <tbody>
                            <tr>
                                <td>#2356</td>
                                <td><img src="/dalam/images/product/img-7.png" width="42" class="me-3" alt="">Green Chair</td>
                            ...
                            <tr>
                                <td>#2564</td>
                                <td><img src="/dalam/images/product/img-8.png" width="42" class="me-3" alt="">Office Chair</td>
                                <td>Alfred Gordon</td>
                                <td>$242.00</td>
                                <td>54</td>
                                <td><span
                            ...
                            <tr>
                                <td>#2125</td>
                                <td><img src="/dalam/images/product/img-10.png" width="42" class="me-3" alt="">Gray Chair</td>
                                <td>Keena Reyes</td>
                                <td>$320.00</td>
                                <td>65</td>
                                <td><span
                            ...
                            <tr>
                                <td>#8587</td>
                                <td><img src="/dalam/images/product/img-11.png" width="42" class="me-3" alt="">Steel Chair</td>
                            ...
                            <tr>
                                <td>#2354</td>
                                <td><img src="/dalam/images/product/img-12.png" width="42" class="me-3" alt="">Home Chair</td>
                                <td>Joann Wiliams</td>
                                <td>$320.00</td>
                                <td>25</td>
                                <td><span
