                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">Detail Pemulung(IPI)</li>
                        </ol>
                        </div>
                    </div>
                    </div>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <ul class="nav nav-tabs border-tab" id="top-tab" role="tablist">
                                            <li class="nav-item"><a class="nav-link active" id="top-home-tab" data-bs-toggle="tab" href="#top-home" role="tab" aria-controls="top-home" aria-selected="true"><i data-feather="target"></i>Pemulung(IPI)</a></li>
                                        </ul>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="text-end">
