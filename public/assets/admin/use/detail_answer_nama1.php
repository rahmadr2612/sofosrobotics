                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <ul class="nav nav-tabs border-tab" id="top-tab" role="tablist">
                                            <li class="nav-item"><a class="nav-link active" id="top-home-tab" data-bs-toggle="tab" href="#top-home" role="tab" aria-controls="top-home" aria-selected="true"><i data-feather="target"></i>Bambang</a></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                                                            ...
                                                            <div class="table-responsive">
                                                                <table class="table">
                                                                    ...
                                                                    <tbody>
                                                                        ...
                                                                        <tr>
                                                                            <th>5</th>
                                                                            <td>Jenis Sampah yang Dihasilkan</td>
                                                                            <td>Organik</td>
                                                                        </tr>
                                                                        <tr>
                                                                            <th>6</th>
                                                                            <td>Jumlah Sampah Dihasilkan Perhari</td>
                                                                            <td>3 Kg</td>
                                                                        </tr>
                                                                        <tr>
                                                                            <th>7</th>
                                                                            <td>Sudah Familiar Menggunakan Smartphone?</td>
                                                                            <td>Ya</td>
                                                                        </tr>
                                                                    </tbody>
                                                                </table>
